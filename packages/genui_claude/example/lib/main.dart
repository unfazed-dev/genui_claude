...
/// Example app demonstrating genui_claude usage.
class GenUiClaudeExampleApp extends StatelessWidget {
  const GenUiClaudeExampleApp({super.key});

  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'GenUI Claude Demo',
      theme: ThemeData(
...
class HomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('GenUI Claude Examples'),
        ...
        child: Column(
          ...
          children: [
            ...
            const Text(
              ...
              '1. A Claude API key for direct mode\n'
