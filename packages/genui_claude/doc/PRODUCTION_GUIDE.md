...
This guide covers production hardening features and best practices for deploying `genui_claude` in production environments.
...
// All exceptions extend ClaudeException
sealed class ClaudeException {
  String get message;
