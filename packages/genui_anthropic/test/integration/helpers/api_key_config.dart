...
/// 1. Dart define: --dart-define=TEST_ANTHROPIC_API_KEY=...
/// 2. Environment variable: TEST_ANTHROPIC_API_KEY
class ApiKeyConfig {
  ApiKeyConfig._();
  ...
  static String? get apiKey {
    ...
    final envKey = Platform.environment['TEST_ANTHROPIC_API_KEY'];
  ...
  static const skipMessage =
      'Integration tests require TEST_ANTHROPIC_API_KEY. '
