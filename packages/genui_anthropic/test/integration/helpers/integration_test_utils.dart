...
/// Creates an [AnthropicContentGenerator] configured for integration testing.
///
/// Uses smaller token limits for faster responses.
AnthropicContentGenerator createIntegrationGenerator({
...
Future<IntegrationTestResult> waitForResponse(
  AnthropicContentGenerator generator,
  ChatMessage message, {
