/// GenUiConversation integration tests for AnthropicContentGenerator.
///
/// These tests verify that AnthropicContentGenerator works correctly
...
void main() {
  group('GenUiConversation Integration', () {
    group('Conversation Creation', () {
      test('GenUiConversation accepts AnthropicContentGenerator', () {
      ...
      test('GenUiConversation with callbacks accepts AnthropicContentGenerator', () {
        final mockHandler = MockApiHandler();
        final generator = AnthropicContentGenerator.withHandler(
          handler: mockHandler,
        );
    ...
    group('Dispose', () {
      test('dispose cleans up conversation resources', () {
        ...
        final testGenerator = AnthropicContentGenerator.withHandler(
          handler: testHandler,
        );
