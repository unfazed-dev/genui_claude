/// Interface compliance tests for AnthropicContentGenerator.
///
/// These tests verify that AnthropicContentGenerator correctly implements
...
void main() {
  group('GenUI Interface Compliance', () {
    group('Type System Compliance', () {
      test('AnthropicContentGenerator implements ContentGenerator', () {
      ...
      test('AnthropicContentGenerator.proxy implements ContentGenerator', () {
      ...
      test('AnthropicContentGenerator.withHandler implements ContentGenerator', () {
