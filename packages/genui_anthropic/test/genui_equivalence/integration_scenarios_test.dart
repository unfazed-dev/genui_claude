/// Integration scenario tests for AnthropicContentGenerator.
///
/// These tests verify real-world usage patterns with GenUiConversation,
/// ensuring genui_anthropic works correctly in typical integration scenarios.
@TestOn('vm')
library;
  ...
  group('GenUI Integration Scenarios', () {
    group('Multiple Conversation Management', () {
      test('two generators with separate mock handlers work independently',
        ...
        final gen1 = AnthropicContentGenerator.withHandler(handler: handler1);
        final gen2 = AnthropicContentGenerator.withHandler(handler: handler2);
