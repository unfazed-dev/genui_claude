...
The genui_anthropic package needs to handle various failure modes when communicating with the Claude API:
...
class ServerException extends AnthropicException { ... }
class StreamException extends AnthropicException { ... }
class CircuitBreakerOpenException extends AnthropicException { ... }
```
...
3. **Coupling**: Code catching AnthropicException is coupled to this hierarchy
