...
Pure Dart package for converting between Anthropic's Claude API responses and A2UI (Agent-to-UI) protocol messages.
...
- Flutter apps (via genui_anthropic)
...
- [genui_anthropic](../genui_anthropic/) - Flutter widgets for A2UI rendering
