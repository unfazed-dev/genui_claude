/// Mock response fixtures for a2ui_claude tests.
///
...
class MockStreamEvents {
  ...
  static Map<String, dynamic> messageDelta({String? stopReason = 'end_turn'}) =>
      {
        'type': 'message_delta',
  ...
  static const Map<String, dynamic> messageStop = {'type': 'message_stop'};
...
class MockToolUseBlocks {
  ...
  static Map<String, dynamic> deleteSurface({
    ...
    'id': id,
    'name': 'delete_surface',
    'input': {'surfaceId': surfaceId, 'cascade': cascade},
  };
}
...
class MockErrorResponses {
  ...
  static Map<String, dynamic> rateLimit({String retryAfter = '30'}) => {
    'type': 'error',
    'error': {
...
class MockStreamSequences {
  ...
  static List<Map<String, dynamic>> errorSequence({
    ...
    MockStreamEvents.messageStart(),
    MockStreamEvents.toolUseStart(index: 0, toolName: 'begin_rendering'),
    MockStreamEvents.inputJsonDelta(index: 0, partialJson: '{"surfaceId":'),
