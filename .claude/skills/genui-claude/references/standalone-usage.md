...
The `a2ui_claude` package is a **pure Dart package** with zero Flutter dependencies. It can be used in CLI applications, server-side Dart, edge functions, and anywhere Dart runs.

## Package Overview

```
genui_claude monorepo:
├── a2ui_claude        ← Pure Dart (this document)
│   ├── A2UI protocol messages
│   ├── Claude stream handler
│   ├── Tool conversion utilities
│   └── Works everywhere Dart runs
│
└── genui_claude       ← Flutter integration
...
For non-Flutter projects, add only `a2ui_claude`:
...
Future<Response> onRequest(RequestContext context) async {
  ...
  // Use a2ui_claude for tool conversion
...
While Supabase Edge Functions use TypeScript, you can use `a2ui_claude` in Dart-based edge function platforms or compile to JavaScript:
...
## Comparison: a2ui_claude vs genui_claude

| Feature | a2ui_claude | genui_claude |
|---------|---------------|-----------------|
...
## When to Use a2ui_claude Directly
