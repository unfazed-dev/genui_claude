#!/usr/bin/env dart
/// Mock SSE Generator for GenUI Claude Testing
///
...
///
/// Usage:
///   dart run .claude/skills/genui-claude/scripts/mock_sse_generator.dart
///
/// Options:
...
void main(List<String> args) {
  ...
  print('GenUI Claude Mock SSE Generator');
  print('===================================');
  print('');
        ...
        widgets: [
          {
            ...
            'properties': {
              ...
              'content': 'This card was created by Claude using the GenUI Claude SDK.',
              'variant': 'elevated',
            },
          },
        ],
