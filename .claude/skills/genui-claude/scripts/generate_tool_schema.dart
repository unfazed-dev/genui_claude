#!/usr/bin/env dart
/// Tool Schema Generator for GenUI Claude
///
...
///
/// Usage:
///   dart run .claude/skills/genui-claude/scripts/generate_tool_schema.dart
///
/// Output formats:
...
String toMarkdown(List<Map<String, dynamic>> tools) {
  ...
  buffer.writeln();
  buffer.writeln('Generated tool schemas for GenUI Claude.');
  buffer.writeln();
...
void main(List<String> args) {
  ...
  print('GenUI Claude Tool Schema Generator');
  print('=====================================');
  print('');
