...
All exceptions extend the sealed `AnthropicException` base class, enabling exhaustive pattern matching:
...
```dart
abstract class AnthropicException implements Exception {
